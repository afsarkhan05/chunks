...
import com.bigdata.chunks.bean.CategoryMaster;
import com.bigdata.chunks.bean.RecoverMaster;
...
import com.bigdata.chunks.util.CustomDate;
import com.bigdata.chunks.util.HibernateUtil;
...
/*	public boolean addAwards(AwardForm awardForm){
	...
	public List getArticle(ArticleFormBean articleForm){
		...
		String sql="select am.articleDesc, am.articleTitle, am.articleLocation, am.categoryId from ArticleMaster am where articleId="+articleForm.getArticleId();
		Query q=session.createQuery(sql);
